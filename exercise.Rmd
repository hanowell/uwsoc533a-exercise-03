...
### Calculate the channel-standardized crude customer conversion rate using the main website as a standard

## Question set 3

### Decompose the difference in CDR between low- and high-income countries into its age-specific components

### Calculate the total contribution of mortality rate schedule and age structure differences to the CDR difference

## Question 4

### Decompose the difference in crude customer conversion rate between main and partner website into its channel-specific components

### Calculate the total contribution of conversion rate schedule and channel structure differences to the overall crude conversion rate difference

## Question 5

### Find the occurrences for a cohort age-specific period rate

### Find the starting line for a cohort

## Question 6

### Explain whether or not you can find the cohort age-specific probability of death from these population counts

### Do it again for another example

## Question 7

### Data collection

### Calculate the tenure-specific probability of promotion in the first half of the second year of employment
